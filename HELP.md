...
* The original package name 'com.xyz.threatre-aggregator' is invalid and this project uses 'com.xyz.threatre_aggregator' instead.
...
* [Spring for Apache Kafka](https://docs.spring.io/spring-boot/3.4.9/reference/messaging/kafka.html)
